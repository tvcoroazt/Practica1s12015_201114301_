 ...
 * @author VicVCoro
 */
public class jugador2Z extends javax.swing.JFrame {

    /**
     * Creates new form jugador2Z
     */
    public jugador2Z() {
        initComponents();
    }
   public static listaUsuarios PZombies = new listaUsuarios();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Agregar mas campos");
  ...
  PZombies.Cabeza(this.jTextField1.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        campoZJ2 campoZJ2 = new campoZJ2();
        campoZJ2.setVisible(true);
 ...
 vent.jugadores.AgregarNodo("ast", 43, "guassdte");
      ...
      //   System.out.println("Jdl" + vent.jugadores.ImpimirLista());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jugador2Z.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
